...
const getVolunteerObject = async (req, res) => {
  ...
  const retrievedVolunteerObject = await MongooseConnector.getVolunteer(
    volunteerObjectId
  );
...
module.exports = (app) => {
  ...
  app.post("/api/volunteer/:id/hours/completed", async (req, res) => {
    ...
    if (volunteerObject !== null) {
      ...
      const success = await MongooseConnector.saveVolunteerCompletedHours(
        req.params.id,
        hours
      );
  ...
  app.post("/api/volunteer/:id/hours/not-completed", async (req, res) => {
    ...
    if (volunteerObject !== null) {
      ...
      const success = await MongooseConnector.saveVolunteerNotCompletedHours(
        req.params.id,
        hours
      );
